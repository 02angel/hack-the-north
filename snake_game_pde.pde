...
//checks if the snake ate an apple in the previous frame
boolean ateApple = false;

//increases as game goes on --> more obstacles
int difficulty = 1;
...
void draw() {
  frameRate(speed);
  //exponentially increases the speed of the snake overtime
  if (speed<10) {
    speed+=0.0078125;
  }
